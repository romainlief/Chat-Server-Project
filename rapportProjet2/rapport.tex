...
\begin{itemize} % TODO -> CHANGER LES EXEMPLES EN EXEMPLE/FONCTION
    ...
    \item \textbf{Impressions des messages:} L'utilisation de mutex était égallement indispensable afin de s'assurer que les messages reçus par un client s'affichent de manière efficace et claire en évitant 
    les problèmes de concurence. Sans cela, les différentes écritures se seraient chevauché, rendant le résultat final illisible. 
\end{itemize}
